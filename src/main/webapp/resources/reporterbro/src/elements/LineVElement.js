 ...
 * @class
 */
export default class LineVElement extends DocElement {
    constructor(id, initialData, rb) {
        super(rb.getLabel('docElementVLine'), id, 100, 1, rb);
        this.color = '#000000';
    ...
    createElement() {
        this.el = $(`<div id="rbro_el${this.id}" class="rbroDocElement rbroLineVElement"></div>`);
