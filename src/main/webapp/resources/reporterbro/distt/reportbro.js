...
var _AddDeleteDocElementCmd = __webpack_require__(25);
...
var _Band = __webpack_require__(14);
...
var DocElement = function () {
    ...
    (0, _createClass3.default)(DocElement, [{
                ...
                try {
                    var _loop = function _loop() {
                        ...
                        var elSizer = $('<div class="rbroSizer rbroSizer' + sizer + '"></div>').mousedown(function (event) {
                            _this2.rb.getDocument().startDrag(event.pageX, event.pageY, _this2.id, _this2.containerId, _this2.linkedContainerId, _this2.getElementType(), DocElement.dragType['sizer' + sizerVal]);
                            event.stopPropagation();
                        });
                ...
                if (paramParent !== null && paramParent.getValue('type') === _Parameter2.default.type.map) {
                    ...
                    try {
                        for (var _iterator5 = (0, _getIterator3.default)(dataSources), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                            ...
                            try {
                                for (var _iterator6 = (0, _getIterator3.default)(dataSource.parameters), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                                    var dataSourceParam = _step6.value;
        ...
        value: function addCommandsForDelete(cmdGroup) {
            ...
            try {
                for (var _iterator7 = (0, _getIterator3.default)(elements), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
        ...
        value: function toJS() {
            ...
            try {
                for (var _iterator8 = (0, _getIterator3.default)(this.getFields()), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
    ...
    (0, _createClass3.default)(Parameter, [{
                    ...
                    if (Array.isArray(testData)) {
                        ...
                        try {
                            for (var _iterator12 = (0, _getIterator3.default)(testData), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
                                ...
                                try {
                                    for (var _iterator13 = (0, _getIterator3.default)(fields), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
        ...
        value: function removeIds(data) {
            if (data.children) {
                ...
                try {
                    for (var _iterator14 = (0, _getIterator3.default)(data.children), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
...
var _AddDeleteParameterCmd = __webpack_require__(56);

var _AddDeleteParameterCmd2 = _interopRequireDefault(_AddDeleteParameterCmd);

var _AddDeleteStyleCmd = __webpack_require__(57);
...
var _DocumentProperties = __webpack_require__(38);
        ...
        value: function initializeEventHandlers() {
            ...
            $('#rbro_document_panel').mousemove(function (event) {
                if (_this2.dragging) {
                    ...
                    var dragObject = _this2.rb.getDataObject(_this2.dragObjectId);
                    if (dragObject !== null) {
                        var dragDiff = dragObject.getDragDiff(event.originalEvent.pageX - _this2.dragStartX, event.originalEvent.pageY - _this2.dragStartY, _this2.dragType, _this2.dragSnapToGrid && _this2.isGridVisible() ? _this2.getGridSize() : 0);
                        _this2.rb.updateSelectionDrag(dragDiff.x, dragDiff.y, _this2.dragType, null, false);
                    }
                }
                if (_this2.selectionAreaStarted) {
                    var offset = _this2.elDocContent.offset();
                    var area = _this2.getSelectionArea(event.originalEvent.pageX - offset.left, event.originalEvent.pageY - offset.top);
                    var props = {
                        left: _this2.rb.toPixel(area.left), top: _this2.rb.toPixel(area.top),
                        width: _this2.rb.toPixel(area.width), height: _this2.rb.toPixel(area.height) };
                    _this2.elSelectionArea.css(props);
                    if (_this2.elSelectionArea.hasClass('rbroHidden')) {
                        // show element after css properties are set
                        _this2.elSelectionArea.removeClass('rbroHidden');
                    }
                }
            });
...
var _SectionElement = __webpack_require__(61);
...
var _TableBandElement = __webpack_require__(62);
...
var TableElement = function (_DocElement) {
    ...
    (0, _createClass3.default)(TableElement, [{
        ...
        key: 'getFields',
        value: function getFields() {
            return ['id', 'containerId', 'x', 'y', 'dataSource', 'columns', 'header', 'contentRows', 'footer', 'border', 'borderColor', 'borderWidth', 'spreadsheet_hide', 'spreadsheet_column', 'spreadsheet_addEmptyRow'];
        }
    }, {
        key: 'getElementType',
        value: function getElementType() {
        ...
        value: function notifyColumnWidthResized(tableBand, columnIndex, newColumnWidth) {
            ...
            if (tableBand !== this.headerData) {
                ...
                if (_column !== null) {
                    _column.updateDisplayInternalNotify(0, 0, newColumnWidth, _column.getValue('heightVal'), false);
                }
            }
            for (var i = 0; i < this.contentDataRows.length; i++) {
                if (tableBand !== this.contentDataRows[i]) {
                    ...
                    if (_column2 !== null) {
                        _column2.updateDisplayInternalNotify(0, 0, newColumnWidth, _column2.getValue('heightVal'), false);
                    }
                }
            }
            if (tableBand !== this.footerData) {
                ...
                if (_column3 !== null) {
                    _column3.updateDisplayInternalNotify(0, 0, newColumnWidth, _column3.getValue('heightVal'), false);
                }
            }
            var width = this.headerData.getWidth();
...
var _MenuPanel = __webpack_require__(88);
...
var ReportBro = function () {
    function ReportBro(element, properties) {
        ...
        this.nextId = 1;
        this.locale = {
            bandContent: 'Contenido',
            bandFooter: 'Pie de página',
            bandHeader: 'Enzabezado',
            barCodeElementContent: 'Contenido',
            barCodeElementDisplayValue: 'Muestra valor',
            barCodeElementFormat: 'Formato',
            contentHeight: 'Altura de contenido',
            contentHeightInfo: 'affects only GUI size to place elements and not the real page size',
            docElementAlwaysPrintOnSamePage: 'Siempre en la misma página',
            docElementBarCode: 'Código de barras',
            docElementColor: 'Color',
            docElementConditionalStyle: 'Estilo condicional',
            docElementConditionalStyleCondition: 'Condición',
            docElementDataSource: 'Data source',
            docElementFrame: 'Frame',
            docElementHeight: 'Altura',
            docElementImage: 'Imagen',
            docElementLabel: 'Etiqueta',
            docElementLine: 'Línea',
            docElementPageBreak: 'salto de página',
            docElementPosition: 'Posición (x, y)',
            docElementPositionX: 'Posición (x)',
            docElementPositionY: 'Posición (y)',
            docElementPrintIf: 'Imprimir si',
            docElementPrintSettings: 'Configuración de impresión',
            docElementRemoveEmptyElement: 'Eliminar cuando esté vacío',
            docElementRoot: 'Documento',
            docElementSection: 'Sección',
            docElementSize: 'tamaño (anchura , altura)',
            docElementSpreadsheet: 'Hoja de cálculo',
            docElementSpreadsheetAddEmptyRow: 'Añadir fila vacía debajo',
            docElementSpreadsheetColspan: 'Rango de columna',
            docElementSpreadsheetColumn: 'Columna fija',
            docElementSpreadsheetHide: 'Esconder',
            docElementWidth: 'Anchura',
            docElementStyle: 'Estilo',
            docElementTable: 'tabla',
            docElementText: 'Texto',
            documentProperties: 'Propiedades del documento',
            documentTabClose: 'Cerrar',
            documentTabPdfLayout: 'Diseño de PDF',
            documentTabPdfPreview: 'PDF Preview',
            documentTabXlsxDownload: 'Descargar XLSX',
            emptyPanel: 'Panel vacío',
            errorMsgDuplicateParameterField: 'El campo ya existe',
            errorMsgInvalidArray: 'Lista inválida',
            errorMsgInvalidAvgSumExpression: 'La expresión debe contener el campo de número de un parámetro de lista',
            errorMsgInvalidBarCode: 'Contenido de código de barras no válido',
            errorMsgInvalidDataSource: 'Fuente de datos no válida',
            errorMsgInvalidDataSourceParameter: 'El parámetro debe ser una lista',
            errorMsgInvalidDate: 'Fecha inválida, el formato esperado es YYYY-MM-DD ( or YYYY-MM-DD hh:mm for date with time)',
            errorMsgInvalidExpression: 'Expresión inválida: ${info}',
            errorMsgInvalidExpressionFuncNotDefined: 'Función ${info} no definida',
            errorMsgInvalidExpressionNameNotDefined: 'Nombre ${info} no definida',
            errorMsgInvalidImage: 'Datos de imagen no válidos, la imagen debe estar codificada en base64',
            errorMsgInvalidImageSource: 'Fuente inválida, url esperado comenzando conhttp:// or https://',
            errorMsgInvalidImageSourceParameter: 'El parámetro debe ser una imagen o cadena (que contenga una url)',
            errorMsgInvalidMap: 'Colección inválida',
            errorMsgInvalidNumber: 'Número invalido',
            errorMsgInvalidPageSize: 'Tamaño de página no válido',
            errorMsgInvalidParameterData: 'Los datos no coinciden con el parámetro',
            errorMsgInvalidParameterName: 'El nombre debe comenzar con un carácter o un guión bajo, y solo debe contener caracteres, dígitos y guiones bajos (_)',
            errorMsgInvalidPattern: 'Patrón inválido',
            errorMsgInvalidPosition: 'La posición está fuera del área',
            errorMsgInvalidSize: 'El elemento está fuera del área',
            errorMsgInvalidTestData: 'Datos de prueba inválidos',
            errorMsgMissingData: 'Datos perdidos',
            errorMsgMissingDataSourceParameter: 'Parámetro de fuente de datos no encontrado',
            errorMsgMissingExpression: 'La expresión debe ser establecida',
            errorMsgMissingImage: 'Imagen faltante, sin fuente ni archivo de imagen especificado',
            errorMsgMissingParameter: 'Parámetro no encontrado',
            errorMsgMissingParameterData: 'Datos para el parámetro {info} no encontrados',
            errorMsgSectionBandNotOnSamePage: 'La banda de sección no cabe en la misma página',
            errorMsgUnicodeEncodeError: 'El texto contiene caracteres no imprimibles',
            errorMsgUnsupportedImageType: 'La imagen no es compatible con el tipo de imagen (.jpg, .png)',
            footer: 'Pie de página',
            footerDisplay: 'Despliegue',
            footerSize: 'Tamaño de pie de página',
            frameElementShrinkToContentHeight: 'Reducir a la altura del contenido',
            imageElementImage: 'Archivo de imagen',
            imageElementLoadErrorMsg: 'Error al cargar la imagen',
            imageElementSource: 'Fuente',
            header: 'Encabezado',
            headerDisplay: 'Despliegue',
            headerFooterDisplayAlways: 'Siempre',
            headerFooterDisplayNotOnFirstPage: 'No mostrar en la primera página',
            headerSize: 'Tamaño del encabezado',
            menuAlignBottom: 'Alinear la parte inferior',
            menuAlignCenter: 'Alinear al centro',
            menuAlignLeft: 'Alinear a la izquierda',
            menuAlignMiddle: 'Alinear medio',
            menuAlignRight: 'Alinear a la derecha',
            menuAlignTop: 'Alinear arriba',
            menuPreview: 'PREVIEW',
            menuPreviewTip: 'Preview del reporte',
            menuRedo: 'Atrás',
            menuRedoTip: 'Repetir el último comando deshecho',
            menuSave: 'Guardar',
            menuSaveTip: 'Guardar Reporte',
            menuToggleGrid: 'Mostrar/ocultar la cuadrícula',
            menuUndo: 'Atrás',
            menuUndoTip: 'Deshacer el último comando',
            orientation: 'Orientación',
            orientationBottom: 'Fondo',
            orientationLandscape: 'Paisaje',
            orientationLeft: 'Izquierda',
            orientationPortrait: 'Retrato',
            orientationRight: 'Derecha',
            orientationTop: 'Arriba',
            ...
            pageFormatUserDefined: 'Dimensiones propias',
            pageHeight: 'Altura',
            pageMargins: 'Márgenes de página',
            pageWidth: 'Anchura',
            parameter: 'Parámetro',
            parameterAddTestData: 'Añadir fila',
            parameterArrayItemType: 'Tipo de elemento de lista',
            parameterEditTestData: 'Editar',
            parameterEditTestDataNoFields: 'No hay campos definidos para esta lista',
            parameterEval: 'Evaluar',
            parameterExpression: 'Expresión',
            parameterListType: 'Tipo de lista',
            parameterName: 'Nombre',
            parameterNullable: 'Anulable',
            parameterPattern: 'Modelo',
            parameterSearchPlaceholder: 'Parámetros de búsqueda...',
            parameterTestData: 'Datos de prueba',
            parameterTestDataDatePattern: 'YYYY-MM-DD',
            parameterType: 'Tipo',
            parameterTypeArray: 'Lista',
            parameterTypeAverage: 'Promedio',
            parameterTypeBoolean: 'Boolean',
            parameterTypeDate: 'Date',
            parameterTypeImage: 'Imagen',
            parameterTypeMap: 'Colección',
            parameterTypeNumber: 'Número',
            parameterTypeSimpleArray: 'Lista simple',
            parameterTypeString: 'Texto',
            parameterTypeSum: 'Suma',
            parameters: 'Parámetros',
            parametersDataSource: 'Parámetros de la fuente de datoss',
            patternCurrencySymbol: 'Patrón de moneda símbolo',
            patternDate1: 'día.mes.año, e.g. 1.6.1980',
            patternDate2: 'día.mes.año (2-digit), hour(24h):minute, e.g. 1.6.80, 14:30',
            patternDate3: 'día/mes/año (abreviatura del mes), e.g. 1/Jun/1980',
            patternDate4: 'month/day/year (día y mes con cero inicial si un dígito), e.g. 06/01/1980',
            patternLocale: 'Patrón local',
            patternNumber1: 'Mostrar mil separador',
            patternNumber2: 'Mostrar el punto decimal seguido de 3 lugares decimales',
            patternNumber3: 'Mostrar el punto decimal seguido de un mínimo de 2 y un máximo de 4 lugares decimales',
            patternNumber4: 'Mostrar mil separador y punto decimal seguido de 2 decimales.',
            patternNumber5: 'Mostrar el símbolo de moneda delante del número',
            patternSeparatorDates: '--- Patrones de fecha ---',
            patternSeparatorNumbers: '--- Patrones de números ---',
            select: 'seleccionar...',
            style: 'Estilo',
            styleAlignment: 'Alineación',
            styleBackgroundColor: 'Color de fondo',
            styleBold: 'Negrita',
            styleBorder: 'Borde',
            styleBorderAll: 'bordes',
            styleBorderColor: 'Color del borde',
            styleBorderWidth: 'Anchura del borde',
            styleFont: 'Fuente',
            styleFontSizeUnit: 'pt',
            styleHAlignmentCenter: 'Centrado',
            styleHAlignmentLeft: 'Izquierda',
            styleHAlignmentJustify: 'Justificado',
            styleHAlignmentRight: 'Derecha',
            styleItalic: 'Italic',
            styleLineSpacing: 'Espaciado entre líneas',
            styleName: 'Nombre',
            styleNone: 'Ninguna',
            stylePadding: 'Relleno',
            styleTextColor: 'Color del texto',
            styleTextStyle: 'Estilo del texto',
            styleUnderline: 'Subrayar',
            styleVAlignmentBottom: 'Bottom',
            styleVAlignmentMiddle: 'Middle',
            styleVAlignmentTop: 'Top',
            styles: 'Styles',
            tableElementAlternateBackgroundColor: 'Color de fondo alternativo',
            tableElementBorderFrame: 'Frame',
            tableElementBorderFrameRow: 'Marco y fila',
            tableElementBorderGrid: 'Cuadrícula',
            tableElementBorderNone: 'Ninguno',
            tableElementBorderRow: 'Fila',
            tableElementColumns: 'Columnas',
            tableElementContentRows: 'Filas de contenido',
            tableElementGroupExpression: 'Expresión grupal',
            tableElementRepeatHeader: 'Encabezado de repetición',
            textElementContent: 'Texto',
            textElementEval: 'Evaluar',
            textElementPattern: 'Textura'
        };
        ...
        this.menuPanel = new _MenuPanel2.default(element, this, this.documentProperties );
                                    ...
                                    for (var _iterator4 = (0, _getIterator3.default)(_this.clipboardElements), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                                        ...
                                        if (_clipboardElement2.baseClass === 'DocElement') {
                                            ...
                                            if (_clipboardElement2.containerId in mappedContainerIds) {
                                                ...
                                                _clipboardElement2.x = _clipboardElement2.y = 0;
                                            }
                                        ...
                                        if (_obj2 instanceof _DocElement2.default) {
                                            ...
                                            if (tagId !== '') {
                                                ...
                                                if (event.which === 37) {
                                                    ...
                                                    var containerSize = _obj2.getContainerContentSize();
    ...
    (0, _createClass3.default)(ReportBro, [{
        ...
        value: function getParameterByName(parameterName) {
            ...
            try {
                for (var _iterator14 = (0, _getIterator3.default)(parameters), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
                    var parameter = _step14.value;
        ...
        value: function notifyEvent(obj, operation, field) {
            if (obj instanceof _Parameter2.default) {
                ...
                try {
                    for (var _iterator17 = (0, _getIterator3.default)(this.docElements), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
                        var docElement = _step17.value;
        ...
        value: function getStyles() {
            ...
            try {
                for (var _iterator18 = (0, _getIterator3.default)(this.getMainPanel().getStylesItem().getChildren()), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
                    var styleItem = _step18.value;
        ...
        value: function getParameters() {
            ...
            try {
                for (var _iterator19 = (0, _getIterator3.default)(this.getMainPanel().getParametersItem().getChildren()), _step19; !(_iteratorNormalCompletion19 = (_step19 = _iterator19.next()).done); _iteratorNormalCompletion19 = true) {
                    var parameterItem = _step19.value;
        ...
        value: function selectObject(id, clearSelection) {
            ...
            if (obj !== null) {
                ...
                if( obj.name == "Text"){
                    $('#rbro_text_element_content').focus();
                }
        ...
        value: function previewInternal(data, isTestData) {
            ...
            $.ajax(this.properties.reportServerUrl, {
                ...
                success: function success(data) {
                    ...
                    //data.substr(0, 4) === 'key:'
                    if ( data.response ) {
                        self.reportKey = data.response;//substr(4);
        ...
        value: function load(report) {
            ...
            try {
                for (var _iterator36 = (0, _getIterator3.default)(report.styles), _step36; !(_iteratorNormalCompletion36 = (_step36 = _iterator36.next()).done); _iteratorNormalCompletion36 = true) {
                    var styleData = _step36.value;
            ...
            try {
                for (var _iterator37 = (0, _getIterator3.default)(report.parameters), _step37; !(_iteratorNormalCompletion37 = (_step37 = _iterator37.next()).done); _iteratorNormalCompletion37 = true) {
                    var parameterData = _step37.value;
            ...
            try {
                for (var _iterator38 = (0, _getIterator3.default)(report.docElements), _step38; !(_iteratorNormalCompletion38 = (_step38 = _iterator38.next()).done); _iteratorNormalCompletion38 = true) {
                    var _docElementData = _step38.value;
...
var LineElement = function (_DocElement) {
    ...
    function LineElement(id, initialData, rb) {
        ...
        var w = rb.horizontal ? 1 : 100,
            h = rb.horizontal ? 100 : 1;

        var _this = (0, _possibleConstructorReturn3.default)(this, (LineElement.__proto__ || (0, _getPrototypeOf2.default)(LineElement)).call(this, rb.getLabel('docElementLine'), id, w , h , rb));
...
var MenuPanel = function () {
    function MenuPanel(rootElement, rb, documentProperties ) {
    ...
    (0, _createClass3.default)(MenuPanel, [{
        ...
        value: function render() {
            ...
            elElementsDiv.append($('<div id="rbro_menu_element_line" class="rbroButton rbroMenuButton" draggable="true"\n                title="' + this.rb.getLabel('docElementLine') + '">\n                    <span class="fas fa-grip-lines"></span>\n                </div>').on('dragstart', function (event) {
	            _this.rb.horizontal = 0;
                event.originalEvent.dataTransfer.setData('text/plain', '');
                event.originalEvent.dataTransfer.effectAllowed = 'copy';
                _this.rb.startBrowserDrag('docElement', _DocElement2.default.type.line, 'a');
                event.stopPropagation();
            }));
	        elElementsDiv.append($('<div id="rbro_menu_element_linev" class="rbroButton rbroMenuButton" draggable="true"\n                title="Linea Vertical">\n                    <span class="fas fa-grip-lines-vertical"></span>\n                </div>').on('dragstart', function (event) {
		        _this.rb.horizontal = 1;
	            event.originalEvent.dataTransfer.setData('text/plain', '');
		        event.originalEvent.dataTransfer.effectAllowed = 'copy';
	        ...
	        elElementsDiv.append($('<div id="rbro_menu_element_sections" class="rbroButton rbroMenuButton" draggable="true"\n                title="Agregar Página">\n                    <span class="x-fa fa-plus"></span>\n                </div>').on('click', function (event) {

		        _this.rb.numPages = Ext.isEmpty(_this.rb.numPages  ) ? 2 : _this.rb.numPages + 1;

	            var cmd = new _SetValueCmd2.default( _this.documentProperties.getId() , 'rbro_document_properties_page_format', 'pageFormat', 'user_defined', _SetValueCmd2.default.type.select , _this.rb);
		        _this.rb.executeCommand(cmd);

		        cmd = new _SetValueCmd2.default(_this.documentProperties.getId(), 'rbro_document_properties_unit', 'unit', 'mm', _SetValueCmd2.default.type.select, _this.rb);
		        _this.rb.executeCommand(cmd);

		        cmd = new _SetValueCmd2.default(_this.documentProperties.getId(), 'rbro_document_properties_page_width', 'pageWidth', 210 , _SetValueCmd2.default.type.select, _this.rb);
		        _this.rb.executeCommand(cmd);

		        cmd = new _SetValueCmd2.default(_this.documentProperties.getId(), 'rbro_document_properties_page_height', 'pageHeight', _this.rb.numPages * 297 , _SetValueCmd2.default.type.text, _this.rb);
		        _this.rb.executeCommand(cmd);
	        }));
...
var TextElementPanel = function () {
    ...
    (0, _createClass3.default)(TextElementPanel, [{
        ...
        value: function render() {
            ...
            var elFormField = $('<div class="rbroFormField rbroSplit rbroSelector"></div>');
            var elContent = $('<textarea id="rbro_text_element_content" rows="10"></textarea>').on('input', function (event) {
                var obj = _this.rb.getDataObject(_this.selectedObjId);
